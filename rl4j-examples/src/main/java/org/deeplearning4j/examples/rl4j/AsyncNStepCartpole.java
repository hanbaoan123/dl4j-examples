...
public class AsyncNStepCartpole {
	...
	public static AsyncNStepQLearningDiscrete.AsyncNStepQLConfiguration CARTPOLE_NSTEP = new AsyncNStepQLearningDiscrete.AsyncNStepQLConfiguration(
			123, // Random seed
	...
	public static DQNFactoryStdDense.Configuration CARTPOLE_NET_NSTEP = DQNFactoryStdDense.Configuration.builder()
	...
	public static void cartPole() throws IOException {
		...
		// define the training
		AsyncNStepQLearningDiscreteDense<Box> dql = new AsyncNStepQLearningDiscreteDense<Box>(mdp, CARTPOLE_NET_NSTEP,
				CARTPOLE_NSTEP, manager);
