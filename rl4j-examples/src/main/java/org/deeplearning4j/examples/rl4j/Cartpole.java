...
public class Cartpole {
	...
	public static QLearning.QLConfiguration CARTPOLE_QL = new QLearning.QLConfiguration(123, // Random
																								// seed
	...
	public static DQNFactoryStdDense.Configuration CARTPOLE_NET = DQNFactoryStdDense.Configuration.builder().l2(0.001)
			.updater(new Adam(0.0005)).numHiddenNodes(16).numLayer(3).build();
	...
	public static void loadCartpole() throws IOException {
		...
		// showcase serialization by using the trained agent on a new similar
		// mdp (but render it this time)
