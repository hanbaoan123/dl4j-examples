 ...
 */
public class Malmo {
	public static QLearning.QLConfiguration MALMO_QL = new QLearning.QLConfiguration(123, // Random
																							// seed
	...
	private static MalmoEnv createMDP() {
		// Create action space comprised of just discrete north, south, east and
		// west
		MalmoActionSpaceDiscrete actionSpace = new MalmoActionSpaceDiscrete("movenorth 1", "movesouth 1", "movewest 1",
				"moveeast 1");
		actionSpace.setRandomSeed(123);

		// Create a basic observation space that simply contains the x, y, z
		// world position
		MalmoObservationSpace observationSpace = new MalmoObservationSpacePosition();

		// Create a simple policy that just ensures the agent has moved and
		// there is a reward
		MalmoDescretePositionPolicy obsPolicy = new MalmoDescretePositionPolicy();

		// Create the MDP with the above arguments, and load a mission using an
		// XML file
