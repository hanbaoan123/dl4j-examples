...
public class ALE {
	...
	public static HistoryProcessor.Configuration ALE_HP = new HistoryProcessor.Configuration(4, // History
																								// length
			84, // resize width
			110, // resize height
			84, // crop width
	...
	public static QLearning.QLConfiguration ALE_QL = new QLearning.QLConfiguration(123, // Random
																						// seed
	...
	public static DQNFactoryStdConv.Configuration ALE_NET_QL = new DQNFactoryStdConv.Configuration(0.00025, // learning
																											// rate
	...
	public static void main(String[] args) throws IOException {
		...
		// setup the training
		QLearningDiscreteConv<ALEMDP.GameScreen> dql = new QLearningDiscreteConv(mdp, ALE_NET_QL, ALE_HP, ALE_QL,
				manager);
