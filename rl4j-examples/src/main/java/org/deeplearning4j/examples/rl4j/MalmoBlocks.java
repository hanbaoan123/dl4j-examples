...
/**
 * More complex example for Malmo DQN w/ block grid as input. After the network
 * learns how to find the reward on a simple open plane, the mission is made
 * more complex by putting lava in the way.
 * 
